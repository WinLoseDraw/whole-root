    ...
    useEffect(() => {
        ...
        Lectures.forEach((element, index) => {
            if (index == Lectures.length - 1){
                t.push(<End sno={index+1} title={element.title} date='' noOfSubs='' onDelete={onDelete} onUpdate={onUpdate} index={index}/>)
            }else{
                t.push(<Row sno={index+1} title={element.title} date='' noOfSubs='' onDelete={onDelete} onUpdate={onUpdate} index={index}/>)
            }
        });
        setLectureItems(t)
    }, [Lectures])
...
const Row = ({sno, title, date, noOfSub, onUpdate, index}) => {
    return(
        <div style={{display: 'flex'}}>
            <div style={{ width:'5%', border: '1px solid black', borderLeft:'2px solid black', backgroundColor: 'white', padding:'8px'}}>{sno}</div>
            <div style={{ width:'30%', border: '1px solid black', backgroundColor: 'white', padding:'8px'}}>{title}</div>
            <div style={{ width:'30%', border: '1px solid black', backgroundColor: 'white', padding:'8px'}}>{date}</div>
            <div style={{ width:'30%', border: '1px solid black', backgroundColor: 'white', padding:'8px'}}>{noOfSub}</div>
            <div style={{ width:'5%', border: '1px solid black', borderRight:'2px solid black', backgroundColor: 'white', padding:'8px', display:'flex', justifyContent:'center'}}><button onClick={(e)=>{onUpdate(index)}}>&uarr;</button></div>
        </div>
    )
}

const End = ({sno, title, date, noOfSub, onUpdate, index}) => {
    return(
        <div style={{display: 'flex'}}>
            ...
            <div style={{ width:'30%', border: '1px solid black', borderBottom:'2px solid black', backgroundColor: 'white', padding:'8px'}}>{title}</div>
            <div style={{ width:'30%', border: '1px solid black', borderBottom:'2px solid black', backgroundColor: 'white', padding:'8px'}}>{date}</div>
            <div style={{ width:'30%', border: '1px solid black', borderBottom:'2px solid black', backgroundColor: 'white', padding:'8px'}}>{noOfSub}</div>
            <div style={{ width:'5%', border: '1px solid black', borderRight:'2px solid black', borderBottom:'2px solid black', backgroundColor: 'white', padding:'8px', display:'flex', justifyContent:'center'}}><button onClick={(e)=>{onUpdate(index)}}>&uarr;</button></div>
        </div>
    )
}
...
const Head = () => {
    return(
        <div style={{display: 'flex'}}>
            ...
            <div style={{ width:'30%', border: '1px solid black', borderTop:'2px solid black', backgroundColor: 'white', padding:'8px'}}>Title</div>
            <div style={{ width:'30%', border: '1px solid black', borderTop:'2px solid black', backgroundColor: 'white', padding:'8px'}}>Date</div>
            <div style={{ width:'30%', border: '1px solid black', borderTop:'2px solid black', backgroundColor: 'white', padding:'8px'}}>No of subs</div>
            <div style={{ width:'5%', border: '1px solid black', borderTop:'2px solid black', borderRight:'2px solid black', backgroundColor: 'white', padding:'8px'}}>sub</div>
        </div>
    )
}
